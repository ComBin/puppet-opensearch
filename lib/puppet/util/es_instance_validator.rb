...
module Puppet
  ...
  module Util
    # Helper class to assist with talking to the Opensearch service ports.
    class EsInstanceValidator
      ...
      # Utility method; attempts to make an https connection to the Opensearch instance.
      ...
      def attempt_connection
        Timeout.timeout(@timeout) do
          ...
          Puppet.debug "Unable to connect to Opensearch instance (#{@instance_server}:#{@instance_port}): #{e.message}"
          false
        end
